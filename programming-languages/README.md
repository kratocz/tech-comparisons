...
| # | Language | P1 compiler catches | P2 legibility | P3 refactoring | P4 domain model | Sum | Domains (§6.2) |
|---|---|---|---|---|---|---|---|
| 1.–2. | **Kotlin** | ✅ | ✅ | ✅ | ✅ | **0** | 6 — 5th |
| 1.–2. | **Rust** | ✅ | ✅ | ✅ | ✅ | **0** | 7 — 6th |
| 3. | C# | 🟡 | ✅ | ✅ | 🟡 | 2 | 6 — 3rd |
...
| Language | P1 compiler catches | P2 legible to a stranger | P3 safe refactoring | P4 domain model | Sum |
|---|---|---|---|---|---|
