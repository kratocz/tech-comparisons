...
| **Programming languages** — one language to build new projects on for years, across web backend, browser frontend, CLI and data/ML | Three briefs, three verdicts that disagree: **TypeScript** on domain fit; **Kotlin and Rust** tied on language professionalism; **Rust** once concurrency counts — no language wins all three | 2026-08-22 to 2026-08-26 · add. ×4, last 2026-08-26 | 🇬🇧 [English](programming-languages/README.md) · 🇨🇿 [Čeština](programming-languages/README.cs.md) |
