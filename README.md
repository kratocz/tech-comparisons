...
| **Storage replication** — incremental replication between two clusters: ZFS `send`/`recv` vs Ceph RBD and CephFS mirroring | `zfs send -i` orchestrated by zrepl | 2026-08-13 | 🇬🇧 [English](storage-replication/README.md) · 🇨🇿 [Čeština](storage-replication/README.cs.md) |
| **Smartwatch platforms** — Garmin vs Apple vs Samsung, as input to an iPhone 15 Pro vs 16 Pro purchase decision | ⏳ in progress | 2026-08 | 🇨🇿 [Čeština](smartwatch-platforms/README.cs.md) |
